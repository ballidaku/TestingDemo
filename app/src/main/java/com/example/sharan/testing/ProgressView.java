...
public class ProgressView extends View
{
    ...
    private float               countRecorderTime = 14000;
    ...
    private void init(Context paramContext)
    {
        ...
        progressPaint.setColor(Color.parseColor("#19e3cf"));// Blue

        firstPaint.setStyle(Paint.Style.FILL);
        firstPaint.setColor(Color.parseColor("#ffcc42")); //Yellow
...
//            Log.e("perProgress",""+perSecProgress);
        }
